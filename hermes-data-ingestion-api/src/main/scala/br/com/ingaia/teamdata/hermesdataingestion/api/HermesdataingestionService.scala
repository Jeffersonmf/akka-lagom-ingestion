package br.com.ingaia.teamdata.hermesdataingestion.api
...
object HermesdataingestionService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The hermes-data-ingestion service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the HermesdataingestionService.
  */
trait HermesdataingestionService extends Service {
  ...
  override final def descriptor: Descriptor = {
    import Service._
    // @formatter:off
    named("hermes-data-ingestion")
      .withCalls(
        pathCall("/api/hello/:id", hello _),
        pathCall("/api/hello/:id", useGreeting _)
      )
      .withTopics(
        topic(HermesdataingestionService.TOPIC_NAME, greetingsTopic _)
